...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATBBuildableHologram_Statics::NewProp_ValidHitClasses_MetaData[] = {
		{ "Category", "Building" },
		{ "Comment", "//UFUNCTION(BlueprintCallable, Category = \"FactoryGame|Drejn Toolbox|Buildable Hologram\")\n//void SetBuildableClass(TSubclassOf< class AFGBuildable > buildableClass);\n" },
		{ "ModuleRelativePath", "Public/Holograms/TBBuildableHologram.h" },
		{ "ToolTip", "UFUNCTION(BlueprintCallable, Category = \"FactoryGame|Drejn Toolbox|Buildable Hologram\")\nvoid SetBuildableClass(TSubclassOf< class AFGBuildable > buildableClass);" },
	};
#endif
	...
	IMPLEMENT_CLASS(ATBBuildableHologram, 345809999);
